...
- **Interface Web**: Frontend integrado para utilização do sistema
...
│   └── SeedData.cs # Auto popula o banco de dados 
├── wwwroot/                # Frontend
│   ├── index.html # Integração da API com frontend, além de todo a interface grafica do front com HTML e CSS
├── Services/              
